...
public:
    ...
    std::vector<std::vector<int>> cluster_helper(typename pcl::PointCloud<PointT>::Ptr cloud, typename KdTree_euclidean<PointT>::KdTree_euclidean* tree, float distanceTol, int minSize, int maxSize);
